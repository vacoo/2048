...
import 'package:myapp/animation_spec.dart';
...
class GameGridState extends State<GameGrid> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    StoreUpdate<BoardState, Action2> update = GameRedux.stateOf(context);
  ...
  List<AnimatedTile> _animatedTilesForSpec(List<TileMotionSpec> motionSpec, StoreUpdate<BoardState, Action2> update) {
